...
#include <cute/algorithm/gmem.hpp>
...
__global__ void cute_gemm(half_t* const A,
    ...
    float* C){
        ...
        Tensor gC = make_tnesor(make_gmem_ptr(C),Layout<Shape<_32,_32>,Stride<_32,_1>>{});
        ...
        TiledMMA tiledmma = make_tiled_mma(SM80_16x8x16_F32F16F16F32_TN{},
            ...
            Tnesor tcrB = thr_mma.partition_fragment_B(sB);

            Tensor tcgC = thr_mma.partition_C(gC);


            Copy_Atom<SM75_U32x4_LDSM_N{}> copyAtom_A;
            Copy_Atom<SM75_U32x4_LDSM_N{}> copyAtom_B;
